...
public class VMEntity {
    ...
    public String toString() {
        ...
        sb.append(VMEntity.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("vmId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VMEntity) == false) {
            return false;
        }
        VMEntity rhs = ((VMEntity) other);
