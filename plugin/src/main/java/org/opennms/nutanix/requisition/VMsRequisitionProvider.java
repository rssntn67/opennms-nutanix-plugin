...
public class VMsRequisitionProvider extends AbstractRequisitionProvider<AbstractRequisitionProvider.Request> {

    public final static String TYPE = "nutanix-vms";

    public VMsRequisitionProvider(NodeDao nodeDao, ClientManager clientManager, ConnectionManager connectionManager, Class<? extends AbstractRequisitionProvider.Request> requestClass) {
    ...
    @Override
    protected VMsRequisitionProvider.Request createRequest(Connection connection, Map<String, String> parameters) {
        return new VMsRequisitionProvider.Request(connection);
    }
